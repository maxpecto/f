                ...
                <div>
                    <div class="ui text menu m-0 flex justify-between items-center pb-4 text-yellow-400">
                        <div class="flex items-center space-x-1">
                            <span class="iconify" data-icon="ic:baseline-splitscreen" data-inline="false"></span> <a class="item text-xl font-medium">Start With {{ $start_with }}</a>
                        </div>
                    </div>
                                                        ...
                                                        <div class="card-image-content">
                                                            ...
                                                            <div>
                                                                <div class="card-overlay show-icon">
                                                                    <div class="absolute left-0 top-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 ml-1 mt-1 uppercase text-xs flex items-center space-x-1 rounded"><span class="iconify" data-icon="heroicons-solid:fire" data-inline="false"></span><span>Trending</span></div>
                                                                    <span class="absolute left-0 bottom-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 ml-1 mb-1 uppercase text-xs">Movies</span>
                                                    ...
                                                    <div class="card-content-wrap">
                                                        <div class="card-image-content">
                                                            ...
                                                            <div>
                                                                <div class="card-overlay show-icon">
                                                                    <div class="absolute left-0 top-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 ml-1 mt-1 uppercase text-xs flex items-center space-x-1 rounded"><span class="iconify" data-icon="heroicons-solid:fire" data-inline="false"></span><span>Trending</span></div>
                                                                    <span class="absolute left-0 bottom-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 ml-1 mb-1 uppercase text-xs">Series</span>
                                                                    <div class="absolute right-0 top-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 mr-1 mt-1 uppercase text-xs flex items-center rounded">
                                                                        <span class="iconify mr-1" data-icon="akar-icons:star" data-inline="false"></span>{{ $latest->rating }}
                                                                    </div>
                                                                </div>
                    ...
                    @else
                        <div class="flex items-center text-yellow-400"><span>There is no items start with {{ $start_with }}</span></div>
                    @endif
                    {{-- Pagination --}}
                    <div class="flex mt-5">
                        {{ $alpa_lists->links('frontend.layouts.pagination')  }}
                    </div>
