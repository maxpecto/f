                ...
                <div>
                    <div class="ui text menu m-0 flex justify-between items-center pb-4 text-yellow-400">
                        <div class="flex items-center space-x-1">
                            <span class="iconify" data-icon="ic:baseline-splitscreen" data-inline="false"></span> <a class="item text-xl font-medium">{{ __("Trendings") }}</a>
                        </div>
                    </div>
                                                        ...
                                                        <div class="card-image-content">
                                                            ...
                                                            <div>
                                                                <div class="card-overlay show-icon">
                                                                    <div class="absolute left-0 top-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 ml-1 mt-1 uppercase text-xs flex items-center space-x-1 rounded"><span class="iconify" data-icon="heroicons-solid:fire" data-inline="false"></span><span>{{ __("Trending") }}</span></div>
                    ...
                    @else
                        <div class="flex items-center text-yellow-400"><span>{{ __("There is no trendings items!") }}</span></div>
                    @endif
                    {{-- Pagination --}}
                    <div class="flex mt-5">
                        {{ $trendings_lists->links('frontend.layouts.pagination')  }}
                    </div>
