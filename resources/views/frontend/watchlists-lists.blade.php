                ...
                <div>
                    <div class="ui text menu m-0 flex justify-between items-center pb-4 text-yellow-400">
                        <div class="flex items-center space-x-1">
                            <span class="iconify" data-icon="ic:baseline-splitscreen" data-inline="false"></span> <a class="item text-xl font-medium">{{ __("Watchlists") }}</a>
                        </div>
                    </div>
                                                        ...
                                                        <div class="card-image-content">
                                                            ...
                                                            <div>
                                                                <div class="card-overlay show-icon">
                                                                    <span class="absolute left-0 top-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 ml-1 mt-1 uppercase text-xs">{{ _("Movies") }}</span>
                                            ...
                                            <div class="card inline-top loaded portrait-card">
                                                <div class="card-content-wrap">
                                                    <div class="card-image-content">
                                                        ...
                                                        <div>
                                                            <div class="card-overlay show-icon">
                                                                <span class="absolute left-0 top-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 ml-1 mt-1 uppercase text-xs">{{ _("Series") }}</span>
                                                                <div class="absolute right-0 top-0 px-2 py-1 bg-gray-900 text-yellow-400 z-50 mr-1 mt-1 uppercase text-xs flex items-center rounded">
                                                                    <span class="iconify mr-1" data-icon="akar-icons:star" data-inline="false"></span>{{ $latest->items->rating }}
                                                                </div>
                                                            </div>
                    ...
                    @else
                        <div class="flex items-center text-yellow-400"><span>{{ __("There is no items in your watchlists!") }}</span></div>
                    @endif
                    {{-- Pagination --}}
                    <div class="flex mt-5">
                        {{ $watchlists_lists->links('frontend.layouts.pagination')  }}
                    </div>
