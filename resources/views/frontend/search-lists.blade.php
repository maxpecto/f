                ...
                <div>
                    <div class="ui text menu m-0 flex justify-between items-center pb-4 text-yellow-400">
                        <div class="flex items-center space-x-1">
                            <span class="iconify" data-icon="ic:baseline-splitscreen" data-inline="false"></span> <a class="item text-xl font-medium">{{ __("Search List") }}</a>
                        </div>
                    </div>
                    ...
                    @else
                        <div class="flex items-center text-yellow-400"><span>{{ __("There is no search results") }}.</span></div>
                    @endif
                </div>
                {{-- Pagination --}}
                <div class="flex mt-5">
                    {{ $data->appends(Request::all())->links('frontend.layouts.pagination')  }}
                </div>
