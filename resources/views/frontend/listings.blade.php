                ...
                <div>
                    <div class="ui text menu m-0 flex justify-between items-center pb-4 text-yellow-400">
                        <div class="flex items-center space-x-1">
                            <span class="iconify" data-icon="ic:baseline-splitscreen" data-inline="false"></span>
                            <a class="item text-xl font-medium">
                                @if(Route::is('genres_lists') )
                                    {{ __("Genres") }} : {{ $heading_name }}
                                @elseif(Route::is('years_lists') )
                                    {{ __("Year") }} : {{ $heading_name }}
                                @elseif(Route::is('countries_lists') )
                                    {{ __("Countries") }} : {{ $heading_name }}
                                @elseif(Route::is('qualities_lists') )
                                    {{ __("Qualities") }} : {{ $heading_name }}
                                @endif
                            </a>
                        </div>
                    </div>
                    ...
                    {{-- Pagination --}}
                    <div class="flex mt-5">
                        {{ $data->links('frontend.layouts.pagination')  }}
                    </div>
