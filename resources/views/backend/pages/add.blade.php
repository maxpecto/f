        ...
        <div class="w-full space-y-6">
            <div  class="w-full">
                ...
                <div class="w-full flex items-center">
                    <input class="w-full rounded px-4 py-2 bg-gray-600 text-white" type="text" name="title" placeholder="Title..">
                </div>
            </div>
            <div  class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Body</h4></label>
                <div class="w-max flex items-center">
                    <textarea name="body" rows="5" cols="40" class="tinymce-editor"></textarea>
                </div>
            </div>
        </div>
    </div>
    <div class="bg-gray-900 justify-between items=center border-1 border-t border-gray-700 p-5 w-full flex items-center">
        <button type="submit" class="bg-green-500 rounded text-white px-4 py-2">Create Page</button>
