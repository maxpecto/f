...
<section class="w-full text-white rounded-b">
    {!! Form::open(['route' => 'admin.members-store','method'=>'post','enctype' => 'multipart/form-data','class' => 'form profile']) !!}
    <div class="bg-gray-700 justify-between items=center border-1 border-t border-gray-700 p-5 w-full xl:flex space-x-0 xl:space-x-6 space-y-6 xl:space-y-0">
        <div class="w-full xl:w-3/12 space-y-6">
            <div class="w-full field image">
                <img src="{{ asset('assets/users/default.png') }}" alt="profile image" id="profile_image" class="w-full">
            ...
            <div class="w-full">
                ...
                <div class="w-full">
                    <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="text" name="location" placeholder="Location..">
                </div>
            </div>
        </div>
        <div class="w-full xl:w-9/12 space-y-6">
            <div  class="w-full">
                ...
                <div class="w-full flex items-center">
                    <span class="p-3 bg-gray-800 rounded-l border-2 border-gray-800">@ </span><input class="w-full rounded-r px-4 py-2 bg-gray-600 text-white" type="text" name="username" placeholder="Username..">
                </div>
            </div>
            <div class="w-full space-x-5 flex">
                <div class="w-6/12">
                    ...
                    <div class="w-full">
                        <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="text" name="fname" placeholder="First Name..">
                    </div>
                </div>
                <div class="w-6/12">
                    <label><h4 class="w-full mb-2 font-medium">Last Name</h4></label>
                    <div class="w-full">
                        <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="text" name="lname" placeholder="Last Name..">
                    </div>
                </div>
            </div>
            <div class="w-full">
                ...
                <div class="w-full">
                    <textarea class="w-full rounded-t px-4 py-4 bg-gray-600 text-white" rows="4" name="description" placeholder="Description.."></textarea>
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Email</h4></label>
                <div class="w-full">
                    <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="email" name="email" placeholder="Email..">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Password</h4></label>
                <div class="w-full">
                    <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="password" name="password" placeholder="Password..">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Website</h4></label>
                <div class="w-full">
                    <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="text" name="website" placeholder="Website..">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Instagram</h4></label>
                <div class="w-full">
                    <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="text" name="instagram" placeholder="Instagram url..">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Twitter</h4></label>
                <div class="w-full">
                    <input class="w-full rounded-t px-4 py-2 bg-gray-600 text-white" type="text" name="twitter" placeholder="Twitter..">
                </div>
            </div>
        </div>
    </div>
    <div class="bg-gray-900 justify-between items=center border-1 border-t border-gray-700 p-5 w-full flex items-center">
        <button type="submit" class="bg-green-500 rounded text-white px-4 py-2">Create User</button>
