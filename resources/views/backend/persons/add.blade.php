...
<section class="w-full text-white rounded-b">
    {!! Form::open(['route' => 'admin.persons-store','method'=>'post','enctype' => 'multipart/form-data']) !!}
    <div class="bg-gray-700 justify-between items=center border-1 border-t border-gray-700 p-5 w-full xl:flex space-x-0 xl:space-x-6 space-y-6 xl:space-y-0">
        <div class="w-full xl:w-3/12 space-y-6">
            <div class="w-full" id="tmdb">
                ...
                <div class="w-full">
                    <input class="w-full rounded-t p-2 bg-gray-600 text-white" type="text" name="persons_tmdb_id" placeholder="TMDB Person ID" val="">
                </div>
            ...
            <div class="w-full field image">
                <img src="{{ asset('assets/image/default_poster.jpg') }}" alt="poster image" id="persons_poster" class="w-full">
                <input type="hidden" name="persons_poster_url" value="">
        ...
        <div class="w-full xl:w-9/12 space-y-6">
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Name</h4></label>
                  <div class="control">
                    <input name="persons_name" id="persons_name" type="text" placeholder="Name" val="" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Biography</h4></label>
                <div class="control">
                    <textarea name="persons_biography" placeholder="Biography" class="w-full rounded p-4 h-20 bg-gray-600 text-white leading-6"></textarea>
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">IMDB ID</h4></label>
                  <div class="control">
                    <input id="persons_imdb_id" type="text" name="persons_imdb_id"  placeholder="IMDB ID.." class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Popularity(TMDB)</h4></label>
                  <div class="control">
                    <input id="persons_popularity" type="text" name="persons_popularity"  placeholder="Popularity.." class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Birth of Date (YYYY-MM-DD)</h4></label>
                  <div class="w-full">
                    <input name="persons_birth_date" type="text" placeholder="Birth of Date" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Death Date (YYYY-MM-DD)</h4></label>
                  <div class="w-full">
                    <input name="persons_death_date" type="text" placeholder="Death Date" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Place of Birth</h4></label>
                  <div class="w-full">
                    <div class="select is-multiple is-primary is-fullwidth">
                        <input id="persons_place_of_birth" name="persons_place_of_birth" type="text" value="" placeholder="Place of Birth.." class="w-full rounded p-2 bg-gray-600 text-white">
                    </div>
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Homepage</h4></label>
                  <div class="control">
                    <input name="persons_homepage" id="persons_homepage" type="text" placeholder="Homepage.." val="" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
        </div>
    </div>
    <div class="bg-gray-900 justify-between items=center border-1 border-t border-gray-700 p-5 w-full flex items-center">
        <button type="submit" class="bg-green-500 rounded text-white px-4 py-2">ADD PERSON</button>
