...
<section class="w-full text-white rounded-b">
    {!! Form::open(['route' => 'admin.series-store','method'=>'post','enctype' => 'multipart/form-data','class' => 'form series']) !!}
    <div class="bg-gray-700 justify-between items=center border-1 border-t border-gray-700 p-5 w-full xl:flex space-x-0 xl:space-x-6 space-y-6 xl:space-y-0">
        <div class="w-full xl:w-3/12 space-y-6">
            <div class="w-full" id="tmdb">
                ...
                <div class="w-full">
                    <input class="w-full rounded-t p-2 bg-gray-600 text-white" type="text" name="series_id" placeholder="TMDB ID" val="">
                </div>
            ...
            <div class="w-full field image">
                <img src="{{ asset('assets/image/default_poster.jpg') }}" alt="poster image" id="series_poster" class="w-full">
                <input type="hidden" name="series_poster_url" val="">
            ...
            <div class="w-full field image">
                <img src="{{ asset('assets/image/default_backdrop.jpg') }}" alt="backdrop image" id="series_image" class="w-full">
            ...
            <div class="w-full">
                ...
                <div class="w-full">
                    <input name="series_duration" type="text" placeholder="Duration" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Rating</h4></label>
                <div class="w-full">
                    <input name="series_rating" type="text" placeholder="Rating" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Release Date (YYYY-MM-DD)</h4></label>
                  <div class="w-full">
                    <input name="series_release_date" type="text" placeholder="Release Date" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
        </div>
        <div class="w-full xl:w-9/12 space-y-6">
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Name</h4></label>
                  <div class="control">
                    <input name="series_name" id="series_name" type="text" placeholder="Name" val="" class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Description</h4></label>
                <div class="control">
                    <textarea name="series_description" placeholder="Description" class="w-full rounded p-4 h-20 bg-gray-600 text-white leading-6"></textarea>
                </div>
            </div>
            <div class="w-full">
            ...
            <div class="w-full">
                <label><h4 class="w-full mb-2 font-medium">Trailer</h4></label>
                  <div class="control">
                    <input name="series_trailer" type="text" placeholder="Trailer Url.." class="w-full rounded p-2 bg-gray-600 text-white">
                </div>
            </div>
            <div class="w-full">
		        ...
		        success: function(data) {
		        	if(data['name'] === undefined){
						...
						if (data['poster_path'] == null) {
						    var series_poster = '{{ URL::asset('backend/images/default_poster.jpg') }}';
						}else{
							var series_poster = 'https://image.tmdb.org/t/p/w500'+data['poster_path'];
						}
						//Backdrop Image
						if (data['backdrop_path'] == null) {
						    var series_image = '{{ URL::asset('backend/images/default_backdrop.jpg') }}';
						}else{
